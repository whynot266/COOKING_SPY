...
public class UserDetailsController {
    ...
    public String deleteFood(@PathVariable(value = "email") String email) {
        ...
        userDetailsServiceImpl.deleteUserFriendList(account.getId());
    ...
    public String showFriendList(Model model, @RequestParam(value = "searchInput") String input) {
        userDetailsServiceImpl.cleanTableFriends();
        ...
        for (AccountEntity accountEntity : accountEntityList) {
            if (userDetailsServiceImpl.checkAwareOrNot(accountService.getAccountByJustEmail(username), accountEntity) == false && userDetailsServiceImpl.checkInvitedOrNot(accountService.getAccountByJustEmail(username), accountEntity) == false) {
                if (!accountEntity.getEmail().contains(username) && !accountEntity.getEmail().equals("admin@gmail.com")) {
